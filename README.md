...
|      | 8     | Th  | 4/25 | [(4) Corpus Mining](#4-Corpus-Mining)                                       | [(4A) Pandas and the dataframe](#4A-Pandas-and-the-dataframe)                                         |                                                                                                                                      | *ToO*, 85-118 [“Wednesday”]      |
| 5    | 9     | T   | 4/30 |                                                                             | [(4B) Comparing word counts](#4B-Comparing-word-counts)                                               | [(3E) Dictionaries and word counts](#3E-Dictionaries-and-word-counts); [(4A) Pandas and the dataframe](#4A-Pandas-and-the-dataframe) |                                  |
|      | 10    | Th  | 5/2  |                                                                             | [(4C) Visualizing word counts](#4C-Visualizing-word-counts)                                           |                                                                                                                                      | *ToO*, 119-150 [“Thursday”]      |
| 6    | 11    | T   | 5/7  | [(5) Clustering](#8-Clustering)                                             | [(5A) Cluster analysis](#5A-Cluster-analysis)                                                         | [(4B) Comparing word counts](#4B-Comparing-word-counts); [(4C) Visualizing word counts](#4C-Visualizing-word-counts)                 |                                  |
|      | 12    | Th  | 5/9  |                                                                             | [(5B) Principal component analysis](#5B-Principal-component-analysis)                                 |                                                                                                                                      | *ToO*, 151-180 [“Friday”]        |
| 7    | 13    | T   | 5/14 | [(6) Natural language processing (NLP)](#6-Natural-language-processing-NLP) | [(6A) Part of speech tagging](#6A-Part-of-speech-tagging)                                             | [(5B) Principal component analysis](#5B-Principal-component-analysis)                                                                |                                  |
|      | 14    | Th  | 5/16 |                                                                             | [(6B) Literary Geography](#6B-Literary-Geography)                                                     |                                                                                                                                      | *ToO*, 181-208 [“Saturday”]      |
| 8    | 15    | T   | 5/21 | [(7) Social network analysis](#7-Social-network-analysis)                   | [(7A) Introduction to networks](#7A-Introduction-to-networks)                                         | [(6A) Part of speech tagging](#6A-Part-of-speech-tagging); [(6B) Literary Geography](#6B-Literary-Geography)                         |                                  |
|      | 16    | Th  | 5/23 |                                                                             | [(7B) Character networks](#7B-Character-networks)                                                     |                                                                                                                                      | *ToO*, 209-230 [“Sunday”]        |
| 9    | 17    | T   | 5/28 | [(8) Content analysis](#8-Content-analysis)                                 | [(8A) Generating topic models](#8A-Generating-topic-models)                                           | [(7B) Character networks](#7B-Character-networks)                                                                                    |                                  |
|      | 18    | Th  | 5/30 |                                                                             | [(8B) Reading topic models](#8B-Reading-topic-models)                                                 |                                                                                                                                      |                                  |
