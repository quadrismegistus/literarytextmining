...
|      | 2     | Th  | 4/4  | Corpora                     | [(2A) Intro to corpora](#2A-Introduction-to-corpora); [(2A) Building a corpus](#2A-Building-a-corpus)   | [(1C) The Terminal](01_setup/01C_the_terminal_TODO)                                                     | ToO, 7-25 [“Monday," ch. 1-3]   |
